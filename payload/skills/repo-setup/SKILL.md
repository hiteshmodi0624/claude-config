...
| [checklists/ticket-board-and-tools.md](checklists/ticket-board-and-tools.md)           | Frontmatter-status ticket board (backlog/icebox/archive tiers), its CLI engine, and the `/tools` internal-ops folder it lives in                                                                                        |
